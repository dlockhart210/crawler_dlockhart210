...
public class ZH_V2 {
    ...
    static long quest = 0;
    static long err = 0;
    static List<String> blackList = Arrays.asList(new String[]{"04607f4149ef669676ab27581da01855"});
